...
cluster_std_list=[0.05, 0.1, 0.25, 0.5]
noise_scale_list=[0.1]
cluster_std_list=[0.5]
for noise_scale in noise_scale_list:
	for cluster_std in cluster_std_list:
		print('noise, cluster std', noise_scale, cluster_std)
		...
		plt.figure(figsize=(5,5))
		plt.plot(gl_cum_regret, label='GL', color='r', marker='o', markersize=8, markevery=0.1)
		...
		plt.figure(figsize=(5,5))
		plt.plot(gl_error, label='GL', color='r', marker='o', markersize=8, markevery=0.1)
